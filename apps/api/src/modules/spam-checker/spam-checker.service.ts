...
const CONTENT_RULES: ContentRule[] = [
  ...
  { ruleId: 'DEBT_ENSURE',          scope: 'both',    pattern: /\bensure\s+you\s+get\b/i,                                      severity: 'high', deduction: 15, message: 'Debt-collection: "ensure you get"',              fix: 'Remove — sounds like a debt notice' },
  { ruleId: 'DEBT_SPEED_UP',        scope: 'both',    pattern: /\bspeed\s+up\s+the\s+process\b/i,                              severity: 'high', deduction: 15, message: 'Spam trigger: "speed up the process"',           fix: 'Remove — high-frequency spam phrase' },
  { ruleId: 'DEBT_FOLLOWUP_HELP',   scope: 'both',    pattern: /\bfollowing\s+up\s+could\s+help\b/i,                           severity: 'high', deduction: 15, message: 'Debt-collection: "following up could help"',    fix: 'Remove — reframe as direct question' },
