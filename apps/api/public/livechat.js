...
`,Be=[{name:"Smileys",emojis:["😀","😃","😄","😁","😆","😅","🤣","😂","🙂","🙃","😉","😊","😇","🥰","😍","🤩","😘","😗","😚","😙","😋","😛","😜","🤪","😝","🤑","🤗","🤭","🤫","🤔","😐","😑","😶","🙄","😏","😒","😞","😔","😟","😕","🙁","☹️","😣","😖","😫","😩","🥺","😢","😭","😤","😠","😡","🤬","🤯","😳","🥵","🥶","😱","😨","😰","😥","😓","🤗","🤔","🤐","🤨","😐","😑","😶","😏","😴","🤤","😪","😵","🤐","🥴","🤢","🤮","🤧","😷"]},{name:"Hearts",emojis:["❤️","🧡","💛","💚","💙","💜","🖤","🤍","🤎","💔","❣️","💕","💞","💓","💗","💖","💘","💝","💟"]},{name:"Hands",emojis:["👍","👎","👌","✌️","🤞","🤟","🤘","🤙","👈","👉","👆","🖕","👇","☝️","👋","🤚","🖐️","✋","🖖","👏","🙌","🤝","🙏","✍️","💪","🦾"]},{name:"Objects",emojis:["🔥","✨","🎉","🎊","🎁","🏆","🥇","⭐","🌟","💫","💥","💯","✅","❌","⚠️","❓","❗","💡","📌","📎","🔗","🔒","🔑","⏰","⏳","📅","📆","🗓️","📊","📈"]},{name:"Travel",emojis:["🚀","✈️","🚗","🚕","🚙","🚌","🏠","🏢","🏥","🏦","🏪","🏫","⛺","🌍","🌎","🌏","🗺️","🏖️","🏔️","🌋"]}],Sn=[[":)","🙂"],[":-)","🙂"],[":D","😄"],[":-D","😄"],["xD","😆"],["XD","😆"],[":P","😛"],[":p","😋"],[":-P","😛"],[":'(","😢"],[":(","🙁"],[":-(","🙁"],[";)","😉"],[";-)","😉"],[":O","😮"],[":o","😮"],[":-O","😮"],[":oO","😳"],[":|","😐"],[":-|","😐"],[":/","😕"],[":-/","😕"],["<3","❤️"],["</3","💔"],[":*","😘"],["B)","😎"]];function En(n){let e=n;for(const[t,s]of Sn){const i=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),r=new RegExp(`(^|\\s)${i}(?=\\s|$|[.,!?])`,"g");e=e.replace(r,`$1${s}`)}return e}const Tn={siteKey:"",botName:"Hi there",botSubtitle:"We typically reply in a few seconds.",welcomeMessage:null,brandColor:"#2563eb",position:"bottom-right"},Re="livechat_messages_cache",$e="livechat_session_id",pe="livechat_identify_dismissed",st="livechat_send_log",ue="livechat_proactive_seen",An=30,In=6e4;function On(n,e=Tn){var u,S;const t=document.createElement("div");t.id="livechat-widget-root",t.style.cssText="position: fixed; bottom: 40px; right: 40px; z-index: 2147483646;",document.body.appendChild(t);const s=t.attachShadow({mode:"open"}),i=(u=Pn(e.brandColor))!=null?u:"#2563eb",r=lt(i,.35),o=lt(i,.45);t.style.setProperty("--lc-brand",i),t.style.setProperty("--lc-brand-shadow",r),t.style.setProperty("--lc-brand-shadow-hover",o),e.position==="bottom-left"&&t.classList.add("lc-position-left");const l=document.createElement("style");l.textContent=_n,s.appendChild(l);const c={open:!1,sessionId:Nn(),messages:Mn(),socket:null,panel:null,askedForEmail:!1,unread:0,sessionClosed:!1,feedbackAsked:!1,operators:(S=e.operators)!=null?S:[],host:t,cfg:n},b=document.createElement("button");b.className="lc-bubble",b.innerHTML=Kn(),s.appendChild(b);const f=document.createElement("span");f.className="lc-unread",f.style.display="none",b.appendChild(f);const x=document.createElement("div");if(x.className="lc-proactive",x.style.display="none",e.welcomeMessage){x.innerHTML=`
    ...
    <div class="lc-header">
      ...
      <div class="lc-header-actions">
        <button class="lc-newchat-btn" aria-label="Start new conversation">${es()}</button>
        <button class="lc-menu-btn" aria-label="Conversation menu" aria-haspopup="true">${Jn()}</button>
        <div class="lc-menu" role="menu" style="display:none;">
          <button class="lc-menu-item" data-action="new">${Xn()} Start a new conversation</button>
          <button class="lc-menu-item" data-action="close">${Qn()} End this chat</button>
        </div>
    ...
    <form class="lc-composer" autocomplete="off">
      ...
      <button type="button" class="lc-attach-btn" aria-label="Attach file">${Fn()}</button>
      <button type="button" class="lc-emoji-btn" aria-label="Insert emoji">${Gn()}</button>
  ...
  `,n.appendChild(r);const o="position: fixed; bottom: 40px; right: 40px; z-index: 2147483646;";r.querySelector(".lc-newchat-btn").addEventListener("click",()=>{confirm("Start a new conversation? The current chat will be cleared.")&&me()}),r.querySelector(".lc-close").addEventListener("click",()=>{t.open=!1,r.classList.add("lc-panel--closing"),setTimeout(()=>{t.open||(r.style.display="none",window.innerWidth<=480&&(t.host.style.cssText=o)),r.classList.remove("lc-panel--closing")},180)});const b=r.querySelector(".lc-menu-btn"),f=r.querySelector(".lc-menu"),x=()=>{f.style.display="none"};b.addEventListener("click",a=>{a.stopPropagation(),f.style.display=f.style.display==="none"?"block":"none"}),r.addEventListener("click",a=>{!f.contains(a.target)&&a.target!==b&&x()}),f.addEventListener("click",async a=>{const d=a.target.closest(".lc-menu-item");if(!d)return;x();const p=d.getAttribute("data-action");if(p==="new"){if(!confirm("Start a new conversation? The current chat will be cleared."))return;me()}else if(p==="close"){if(!confirm("End this chat? You can always start a new one."))return;const w=t.sessionId;if(w)try{await fetch(`${e.apiBase}/livechat/session/${encodeURIComponent(w)}/close`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({siteKey:e.siteKey,visitorId:e.visitorId}),credentials:"omit"})}catch(v){}me(),t.messages=[{id:`system-${Date.now()}`,role:"system",content:"Chat ended. Type a message to start a new conversation.",createdAt:new Date().toISOString()}],W(t.messages),s()}});const m=r.querySelector(".lc-messages"),A=r.querySelector(".lc-scroll-btn");m.addEventListener("scroll",()=>{const a=m.scrollHeight-m.scrollTop-m.clientHeight;A.style.display=a>120?"flex":"none"}),A.addEventListener("click",()=>{m.scrollTop=m.scrollHeight,A.style.display="none"});const R=r.querySelector(".lc-composer"),h=r.querySelector("textarea"),j=r.querySelector(".lc-hp"),U=r.querySelector('.lc-composer button[type="submit"]'),D=r.querySelector(".lc-attach-btn"),u=r.querySelector(".lc-file-input"),S=r.querySelector(".lc-pending"),k=r.querySelector(".lc-quick-replies"),H=r.querySelector(".lc-session-end"),te=r.querySelector(".lc-session-end-btn"),mt=r.querySelector(".lc-emoji-btn"),ge=r.querySelector(".lc-emoji-pop"),yt=r.querySelector(".lc-emoji-tabs"),bt=r.querySelector(".lc-emoji-grid");function ds(a){var v,y;const d=(v=h.selectionStart)!=null?v:h.value.length,p=(y=h.selectionEnd)!=null?y:d;h.value=h.value.slice(0,d)+a+h.value.slice(p);const w=d+a.length;h.setSelectionRange(w,w),h.focus()}function hs(a){const d=Be[a];d&&(bt.innerHTML=d.emojis.map(p=>`<button type="button" class="lc-emoji-pick" data-emoji="${p}">${p}</button>`).join(""))}mt.addEventListener("click",a=>{a.stopPropagation(),ge.style.display=ge.style.display==="none"?"block":"none"}),r.addEventListener("click",a=>{a.target instanceof Node&&!ge.contains(a.target)&&a.target!==mt&&(ge.style.display="none")}),yt.addEventListener("click",a=>{var p;const d=a.target.closest(".lc-emoji-tab");d&&(yt.querySelectorAll(".lc-emoji-tab").forEach(w=>w.classList.remove("lc-emoji-tab-active")),d.classList.add("lc-emoji-tab-active"),hs(Number((p=d.getAttribute("data-cat"))!=null?p:0)))}),bt.addEventListener("click",a=>{var p;const d=a.target.closest(".lc-emoji-pick");d&&ds((p=d.getAttribute("data-emoji"))!=null?p:"")}),h.addEventListener("input",()=>{var p;const a=h.value,d=En(a);if(d!==a){const w=d.length-a.length,v=((p=h.selectionStart)!=null?p:a.length)+w;h.value=d,h.setSelectionRange(v,v)}});function me(){var a;(a=t.socket)==null||a.disconnect(),t.socket=null,t.sessionId=null,t.sessionClosed=!1,t.messages=[],t.askedForEmail=!1,t.unread=0;try{localStorage.removeItem($e)}catch(d){}try{localStorage.removeItem(Re)}catch(d){}try{localStorage.removeItem(pe)}catch(d){}H.style.display="none",h.disabled=!1,U.disabled=!1,D.disabled=!1,i!=null&&i.welcomeMessage&&(t.messages.push({id:"welcome",role:"agent",content:i.welcomeMessage,createdAt:new Date().toISOString()}),W(t.messages)),s()}te.addEventListener("click",me);const E=[],ps=Date.now();let Ne=!1;h.addEventListener("keydown",()=>{Ne=!0}),h.addEventListener("input",()=>{Ne=!0});const xt=()=>{var p;const a=t.messages.some(w=>w.role==="visitor"),d=((p=i.welcomeQuickReplies)!=null?p:[]).filter(Boolean);if(a||d.length===0){k.style.display="none",k.innerHTML="";return}k.style.display="flex",k.innerHTML=d.map((w,v)=>`<button data-i="${v}" type="button">${T(w)}</button>`).join(""),k.querySelectorAll("button").forEach(w=>{w.addEventListener("click",()=>{const v=Number(w.dataset.i),y=d[v];y&&(h.value=y,R.requestSubmit())})})};D.addEventListener("click",()=>u.click()),u.addEventListener("change",async()=>{var w;const a=(w=u.files)==null?void 0:w[0];if(u.value="",!a)return;if(a.size>10*1024*1024){N(r,`File too large: ${a.name} (max 10 MB)`);return}if(E.length>=5){N(r,"You can attach up to 5 files per message.");return}if(!t.sessionId){N(r,"Send a message first, then attach files.");return}const d=a.type.startsWith("image/")?URL.createObjectURL(a):void 0,p={id:"pending-"+Date.now(),mimeType:a.type,sizeBytes:a.size,originalFilename:a.name,url:"",localUrl:d};E.push(p),F();try{const v=await I(e,t.sessionId,a),y=E.indexOf(p);y>=0&&(E[y]=X(K({},v),{localUrl:d})),F()}catch(v){const y=E.indexOf(p);y>=0&&E.splice(y,1),d&&URL.revokeObjectURL(d),N(r,`Upload failed: ${v.message}`),F()}});function F(){if(!E.length){S.style.display="none",S.innerHTML="";return}S.style.display="flex",S.innerHTML=E.map((a,d)=>{var V;const p=a.id.startsWith("pending-"),w=(V=a.localUrl)!=null?V:"",y=a.mimeType.startsWith("image/")&&w?`<img class="lc-chip-thumb" src="${T(w)}" alt="">`:"",q=p?`${y}<span class="lc-chip-label lc-chip-uploading">Uploading…</span>`:`${y}<span class="lc-chip-label">${T(a.originalFilename)}</span><button data-i="${d}" aria-label="Remove">×</button>`;return`<span class="lc-chip${p?" lc-chip--busy":""}">${q}</span>`}).join(""),S.querySelectorAll("button[data-i]").forEach(a=>{a.addEventListener("click",()=>{const d=Number(a.dataset.i),p=E.splice(d,1)[0];p!=null&&p.localUrl&&URL.revokeObjectURL(p.localUrl),F()})})}let qe=null,vt=!1;const ne=a=>{var d;vt!==a&&(vt=a,(d=t.socket)==null||d.emit("livechat:typing",{on:a}))};h.addEventListener("input",()=>{h.style.height="auto",h.style.height=Math.min(120,h.scrollHeight)+"px",h.value.trim()?(ne(!0),qe&&clearTimeout(qe),qe=setTimeout(()=>ne(!1),1500)):ne(!1)}),h.addEventListener("blur",()=>ne(!1)),h.addEventListener("keydown",a=>{a.key==="Enter"&&!a.shiftKey&&(a.preventDefault(),R.requestSubmit())}),h.addEventListener("paste",async a=>{var w;const d=(w=a.clipboardData)==null?void 0:w.items;if(!d)return;const p=[];for(const v of d)if(v.kind==="file"&&v.type.startsWith("image/")){const y=v.getAsFile();y&&p.push(y)}if(p.length){if(a.preventDefault(),!t.sessionId){N(r,"Send a message first, then paste images.");return}for(const v of p){if(v.size>10*1024*1024){N(r,`Pasted image too large: ${v.name||"image"} (max 10 MB)`);continue}if(E.length>=5)break;const y=v.name?v:new File([v],`pasted-${Date.now()}.png`,{type:v.type}),q=URL.createObjectURL(y),V={id:"pending-"+Math.random().toString(36).slice(2),mimeType:v.type,sizeBytes:v.size,originalFilename:y.name,url:"",localUrl:q};E.push(V),F();try{const Me=await I(e,t.sessionId,y),se=E.indexOf(V);se>=0&&(E[se]=X(K({},Me),{localUrl:q})),F()}catch(Me){const se=E.indexOf(V);se>=0&&E.splice(se,1),URL.revokeObjectURL(q),N(r,`Upload failed: ${Me.message}`),F()}}}}),R.addEventListener("submit",async a=>{var v;if(a.preventDefault(),j.value)return;if(t.sessionClosed){N(r,"This conversation has ended. Start a new chat below.");return}const d=h.value.trim(),p=E.some(y=>y.id.startsWith("pending-")),w=E.filter(y=>y.url&&!y.id.startsWith("pending-"));if(p&&!d){N(r,"Your file is still uploading — please wait or add a message.");return}if(!(!d&&!w.length)){if(!Cn()){N(r,"Slow down — too many messages in the last minute.");return}U.disabled=!0,h.value="",h.style.height="auto",ne(!1),$n(t,d,w),E.length=0,F(),xt(),s(),ot(r);try{const y=await Tt(e,d,w.map(q=>q.id),{hp:j.value||void 0,elapsedMs:Date.now()-ps,hadInteraction:Ne});if(Z(r),t.sessionId=y.sessionId,qn(y.sessionId),"content"in y.agent&&y.agent.content){const q=(v=y.agent.id)!=null?v:"";t.messages.some(V=>V.id===q&&q)||at(t,y.agent.content,q)}t.socket||it(e,t,s,i),Rn(r,t)}catch(y){Z(r),N(r,"Could not send — please try again.")}U.disabled=!1,s()}});const J=r.querySelector(".lc-identify"),us=J.querySelector(".lc-identify-name"),fs=J.querySelector('input[type="email"]'),gs=J.querySelectorAll("button")[0],ms=J.querySelectorAll("button")[1];return gs.addEventListener("click",async()=>{const a=fs.value.trim(),d=us.value.trim()||void 0;if(/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(a))try{await At(e,{email:a,name:d}),J.style.display="none";try{localStorage.setItem(pe,"saved")}catch(p){}}catch(p){}}),ms.addEventListener("click",()=>{J.style.display="none";try{localStorage.setItem(pe,"skipped")}catch(a){}}),xt(),r}function it(n,e,t,s){!e.sessionId||e.socket||(e.socket=kn(n,e.sessionId,i=>{var c,b,f,x,m,A,R,h,j,U,D;if(i.type==="typing"){const u=e.panel;if(!u)return;i.on?ot(u):Z(u);return}if(i.type==="session_status"&&i.status==="closed"){(c=e.socket)==null||c.disconnect(),e.socket=null,e.sessionClosed=!0;const u=e.panel;if(u){const S=u.querySelector(".lc-session-end"),k=u.querySelector("textarea"),H=u.querySelector('.lc-composer button[type="submit"]'),te=u.querySelector(".lc-attach-btn");S&&(S.style.display="flex"),k&&(k.disabled=!0),H&&(H.disabled=!0),te&&(te.disabled=!0),e.feedbackAsked||(e.feedbackAsked=!0,e.messages.push({id:`feedback-${Date.now()}`,role:"system",content:"__feedback__",createdAt:new Date().toISOString()}))}t();return}if(i.type==="agent_stream_start"&&i.draftId){const u=e.panel;u&&Z(u),e.messages.some(S=>S.id===i.draftId)||(e.messages.push({id:i.draftId,role:"agent",content:"",createdAt:(b=i.createdAt)!=null?b:new Date().toISOString()}),t());return}if(i.type==="agent_stream_delta"&&i.draftId&&i.delta){const u=e.messages.findIndex(S=>S.id===i.draftId);u>=0&&(e.messages[u]=X(K({},e.messages[u]),{content:e.messages[u].content+i.delta}),t());return}if(i.type==="agent_stream_end"&&i.draftId&&i.messageId){const u=e.messages.findIndex(S=>S.id===i.draftId);u>=0&&(e.messages[u]=X(K({},e.messages[u]),{id:i.messageId,content:(f=i.content)!=null?f:e.messages[u].content}),W(e.messages),e.open||(e.unread=((x=e.unread)!=null?x:0)+1,ct()),t());return}if(i.type==="agent_suggestions"&&i.messageId&&((m=i.suggestions)!=null&&m.length)){const u=e.messages.findIndex(S=>S.id===i.messageId);u>=0&&(e.messages[u]=X(K({},e.messages[u]),{suggestions:i.suggestions.slice(0,3)}),t());return}if(i.type!=="message"||!i.messageId||i.role==="visitor"||e.messages.some(u=>u.id===i.messageId))return;const r=(A=i.operatorName)!=null?A:void 0,o=r&&(j=(h=(R=s==null?void 0:s.operators)==null?void 0:R.find(u=>u.name===r))==null?void 0:h.avatarUrl)!=null?j:void 0;at(e,(U=i.content)!=null?U:"",i.messageId,i.role==="operator",i.attachments,r,o);const l=e.panel;l&&Z(l),e.open||(e.unread=((D=e.unread)!=null?D:0)+1,ct()),t()}))}function Bn(n,e){const t=n.querySelector(".lc-messages");if(!t)return;if(e.messages.length===0){t.innerHTML='<div class="lc-empty">Send us a message — we will get right back to you.</div>';return}const s=(()=>{for(let i=e.messages.length-1;i>=0;i--){const r=e.messages[i];if(r.role==="agent"||r.role==="operator")return i;if(r.role==="visitor")return-1}return-1})();t.innerHTML=e.messages.map((i,r)=>{var A,R;const o=i.content?i.role==="visitor"?Dn(i.content):zn(i.content):"",l=((A=i.attachments)!=null?A:[]).map(jn).join(""),c=l?`<div class="lc-attachments">${l}</div>`:"",b=Hn(i.createdAt),f=b?`<div class="lc-msg-time">${b}</div>`:"",x=r===s&&i.suggestions&&i.suggestions.length?`<div class="lc-chips">${i.suggestions.map(h=>`<button class="lc-chip" data-chip="${B(h)}">${T(h)}</button>`).join("")}</div>`:"";if(i.role==="system")return i.content==="__feedback__"?`<div class="lc-msg lc-msg-system lc-feedback" data-feedback-id="${B(i.id)}">
        ...
        <div class="lc-msg-avatar lc-msg-avatar-ai">${Zn()}</div>
        <div class="lc-msg-body">
          <div class="lc-msg lc-msg-agent">${o}${c}</div>
          ${f}
          ${x}
      ...
      </div>`}).join(""),t.querySelectorAll(".lc-msg-rating").forEach(i=>{i.querySelectorAll(".lc-rate-btn").forEach(r=>{r.addEventListener("click",async()=>{var f,x,m;const o=r.getAttribute("data-rating"),l=(f=i.getAttribute("data-msg-id"))!=null?f:"",c=(m=(x=n._state)==null?void 0:x.sessionId)!=null?m:"",b=n._cfg;if(!(!l||!c||!b)){i.querySelectorAll(".lc-rate-btn").forEach(A=>A.disabled=!0),r.classList.add("lc-rate-btn--active");try{await fetch(`${b.apiBase}/livechat/session/${encodeURIComponent(c)}/message/${encodeURIComponent(l)}/rating`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({siteKey:b.siteKey,visitorId:b.visitorId,rating:o}),credentials:"omit"})}catch(A){}}})})}),t.querySelectorAll(".lc-chip").forEach(i=>{i.addEventListener("click",()=>{var c;const r=n.querySelector("textarea"),o=n.querySelector(".lc-composer"),l=(c=i.getAttribute("data-chip"))!=null?c:"";!r||!o||!l||(r.value=l,o.requestSubmit())})}),t.querySelectorAll(".lc-fb-btn").forEach(i=>{i.addEventListener("click",async()=>{const r=i.closest(".lc-feedback"),o=i.getAttribute("data-rating");if(!r||!o)return;const l=e.sessionId,c=e.cfg;if(l&&c)try{await fetch(`${c.apiBase}/livechat/session/${encodeURIComponent(l)}/feedback`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({siteKey:c.siteKey,visitorId:c.visitorId,rating:o}),credentials:"omit"})}catch(b){}r.innerHTML="<span>Thanks for the feedback!</span>"})}),rt(n)}function rt(n){const e=n.querySelector(".lc-messages");e&&(e.scrollTop=e.scrollHeight)}function ot(n){const e=n.querySelector(".lc-messages");if(!e||e.querySelector(".lc-typing"))return;const t=document.createElement("div");t.className="lc-typing",t.innerHTML="<span></span><span></span><span></span>",e.appendChild(t),e.scrollTop=e.scrollHeight}function Z(n){n.querySelectorAll(".lc-typing").forEach(e=>e.remove())}function Rn(n,e){if(e.askedForEmail)return;try{if(localStorage.getItem(pe))return}catch(s){}if(e.messages.filter(s=>s.role==="agent").length<1)return;e.askedForEmail=!0;const t=n.querySelector(".lc-identify");t&&(t.style.display="block")}function $n(n,e,t){n.messages.push({id:"local-"+Date.now(),role:"visitor",content:e,createdAt:new Date().toISOString(),attachments:t}),W(n.messages)}function at(n,e,t,s=!1,i,r,o){n.messages.push({id:t||"srv-"+Date.now(),role:s?"operator":"agent",content:e,createdAt:new Date().toISOString(),attachments:i,operatorName:r,operatorAvatarUrl:o}),W(n.messages)}function Cn(){var n;try{const e=Date.now(),t=JSON.parse((n=localStorage.getItem(st))!=null?n:"[]").filter(s=>e-s<In);return t.length>=An?!1:(t.push(e),localStorage.setItem(st,JSON.stringify(t)),!0)}catch(e){return!0}}function Nn(){try{return localStorage.getItem($e)}catch(n){return null}}function qn(n){try{localStorage.setItem($e,n)}catch(e){}}function Mn(){try{const n=localStorage.getItem(Re);return n?JSON.parse(n):[]}catch(n){return[]}}function W(n){try{localStorage.setItem(Re,JSON.stringify(n.slice(-50)))}catch(e){}}function ct(){try{const n=new(window.AudioContext||window.webkitAudioContext),e=n.createOscillator(),t=n.createGain();e.connect(t),t.connect(n.destination),e.type="sine",e.frequency.setValueAtTime(880,n.currentTime),e.frequency.setValueAtTime(1100,n.currentTime+.08),t.gain.setValueAtTime(.12,n.currentTime),t.gain.exponentialRampToValueAtTime(.001,n.currentTime+.35),e.start(n.currentTime),e.stop(n.currentTime+.35)}catch(n){}}function T(n){return n.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function Pn(n){if(!n)return null;const e=n.trim();return/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/.test(e)?e:null}function lt(n,e){let t=n.replace("#","");t.length===3&&(t=t.split("").map(o=>o+o).join(""));const s=parseInt(t.slice(0,2),16),i=parseInt(t.slice(2,4),16),r=parseInt(t.slice(4,6),16);return`rgba(${s}, ${i}, ${r}, ${e})`}function jn(n){if(n.mimeType.startsWith("image/")&&n.url)return`<a href="${B(n.url)}" target="_blank" rel="noopener noreferrer"><img class="lc-attach-img" src="${B(n.url)}" alt="${B(n.originalFilename)}" /></a>`;const t=Un(n.sizeBytes);return`<a class="lc-attach-file" href="${n.url?B(n.url):"#"}" target="_blank" rel="noopener noreferrer">${Vn()}<span>${T(n.originalFilename)}</span><span class="lc-attach-size">${t}</span></a>`}function Dn(n){return T(n).replace(/(https?:\/\/[^\s<]+)/g,t=>{const s=t.match(/[.,;:!?)]+$/),i=s?s[0]:"",r=i?t.slice(0,-i.length):t;return`<a href="${B(r)}" target="_blank" rel="noopener noreferrer nofollow">${r}</a>${i}`})}function zn(n){let e=T(n);const t=[];return e=e.replace(/`([^`\n]+)`/g,(s,i)=>(t.push(`<code class="lc-md-code">${i}</code>`),`\0C${t.length-1}\0`)),e=e.replace(/\[([^\]]+)\]\((https?:\/\/[^\s)]+)\)/g,(s,i,r)=>`<a href="${B(r)}" target="_blank" rel="noopener noreferrer nofollow">${i}</a>`),e=e.replace(/\*\*([^*\n]+?)\*\*/g,"<strong>$1</strong>"),e=e.replace(/(^|[\s(])\*([^*\n]+?)\*(?=[\s.,;:!?)]|$)/g,"$1<em>$2</em>"),e=e.replace(/(^|[\s>])(https?:\/\/[^\s<]+)/g,(s,i,r)=>{const o=r.match(/[.,;:!?)]+$/),l=o?o[0]:"",c=l?r.slice(0,-l.length):r;return`${i}<a href="${B(c)}" target="_blank" rel="noopener noreferrer nofollow">${c}</a>${l}`}),e=e.replace(/ C(\d+) /g,(s,i)=>{var r;return(r=t[Number(i)])!=null?r:""}),e=e.replace(/\n/g,"<br>"),e}function B(n){return n.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function Un(n){return n<1024?`${n} B`:n<1024*1024?`${(n/1024).toFixed(0)} KB`:`${(n/1024/1024).toFixed(1)} MB`}function N(n,e,t=3500){const s=n.querySelector(".lc-toast");s&&(s.textContent=e,s.style.display="block",clearTimeout(s._timer),s._timer=setTimeout(()=>{s.style.display="none"},t))}function dt(n){return n.trim().split(/\s+/).map(e=>{var t;return(t=e[0])!=null?t:""}).join("").slice(0,2).toUpperCase()}function Hn(n){try{const e=new Date(n);return isNaN(e.getTime())?"":e.toLocaleTimeString([],{hour:"numeric",minute:"2-digit"})}catch(e){return""}}function Fn(){return'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21.44 11.05-9.19 9.19a6 6 0 0 1-8.49-8.49l8.57-8.57A4 4 0 1 1 17.93 8.83l-8.58 8.57a2 2 0 1 1-2.83-2.83l8.49-8.48"/></svg>'}function Vn(){return'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/></svg>'}function Kn(){return'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>'}function Yn(){return'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>'}function ht(){return'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>'}function Wn(){return'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m22 2-7 20-4-9-9-4Z"/><path d="M22 2 11 13"/></svg>'}function Jn(){return'<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="6" r="1.5"/><circle cx="12" cy="12" r="1.5"/><circle cx="12" cy="18" r="1.5"/></svg>'}function Xn(){return'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 0 1 15.5-6.36L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-15.5 6.36L3 16"/><path d="M3 21v-5h5"/></svg>'}function Qn(){return'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>'}function Gn(){return'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg>'}function Zn(){return'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z"/><path d="M20 3v4M22 5h-4M4 17v2M5 18H3"/></svg>'}function es(){return'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>'}function ts(n){return n.length?`<div class="lc-header-avatars">${n.slice(0,3).map((s,i)=>{const r=i===0?"":"margin-left:-10px;",o=`z-index:${3-i};`;return s.avatarUrl?`<img class="lc-op-avatar" src="${B(s.avatarUrl)}" alt="${T(s.name)}" style="${o}${r}">`:`<div class="lc-op-avatar lc-op-initials" style="${o}${r}">${T(dt(s.name))}</div>`}).join("")}</div>`:`<div class="lc-header-avatar">${Yn()}</div>`}let pt="",ee=null,fe=null;const ns=3e4;function ss(n){ut(n),rs(n),window.addEventListener("popstate",()=>Ce(n)),window.addEventListener("pagehide",()=>{ee&&Pe(n,ee)}),is(n)}function is(n){const e=()=>{document.visibilityState==="visible"&&Et(n,{url:location.href,title:document.title})};setInterval(e,ns),document.addEventListener("visibilitychange",()=>{document.visibilityState==="visible"&&e()})}function rs(n){const e={pushState:history.pushState,replaceState:history.replaceState};history.pushState=function(...t){const s=e.pushState.apply(this,t);return Ce(n),s},history.replaceState=function(...t){const s=e.replaceState.apply(this,t);return Ce(n),s}}function Ce(n){fe&&clearTimeout(fe),fe=setTimeout(()=>ut(n),300)}async function ut(n){var t;fe=null;const e=location.pathname+location.search;if(e!==pt){pt=e,ee&&Pe(n,ee);try{ee=(t=(await St(n,{url:location.href,path:location.pathname,title:document.title,referrer:document.referrer,language:navigator.language})).pageviewId)!=null?t:null}catch(s){}}}const ft="livechat_visitor_id";function os(){const n=as();if(!n)return null;const e=n.getAttribute("data-site");if(!e)return null;const t=n.getAttribute("data-api")||cs(n)||"",s=ls();return{siteKey:e,visitorId:s,apiBase:t}}function as(){const n=document.querySelectorAll("script[data-site]");return n.length?n[n.length-1]:null}function cs(n){if(!n.src)return null;try{const e=new URL(n.src);return`${e.protocol}//${e.host}`}catch(e){return null}}function ls(){try{const n=localStorage.getItem(ft);if(n)return n;const e=gt();return localStorage.setItem(ft,e),e}catch(n){return gt()}}function gt(){if(typeof crypto!="undefined"&&crypto.randomUUID)return crypto.randomUUID();let n=Date.now();return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,e=>{const t=(n+Math.random()*16)%16|0;return n=Math.floor(n/16),(e==="x"?t:t&3|8).toString(16)})}(function(){var s;if(typeof window=="undefined"||(s=window.__livechat__)!=null&&s.mounted)return;const e=os();if(!e)return;window.__livechat__={mounted:!0,siteKey:e.siteKey,visitorId:e.visitorId},ss(e);const t=async()=>{const i=await $(e);On(e,i!=null?i:void 0)};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",t):t()})()})();
