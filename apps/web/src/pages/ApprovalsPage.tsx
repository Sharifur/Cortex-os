...
import { CheckCircle2, XCircle, MessageSquare, Clock, AlertTriangle, ShieldAlert, Bot } from 'lucide-react';
    ...
    <div className="rounded-xl border border-border bg-card p-5">
      ...
      {showFollowup && (
        <div className="flex gap-2 mb-3">
          ...
          <Button size="sm" variant="ghost" onClick={() => { setShowFollowup(false); setInstruction(''); }}>
            Cancel
          </Button>
        </div>
      )}
...
export default function ApprovalsPage() {
  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      {isError && <p className="text-sm text-destructive">Failed to load approvals.</p>}
